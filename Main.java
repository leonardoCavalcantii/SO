...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // disco.setEscalonador(new SSTF());
        disco.write(blocos);
        System.out.println("Tempo total (ms): " + disco.write() + " - " + alg);

//        disco.setEscalonador(new FCFS());
 //       disco.write(blocos);
  //      System.out.println("Tempo total (ms) SSTF: " + disco.write());
    }
